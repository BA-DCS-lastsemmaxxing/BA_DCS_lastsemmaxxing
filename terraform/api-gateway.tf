...
resource "aws_api_gateway_deployment" "prod_deployment" {
  ...
  triggers = {
    redeployment = sha1(jsonencode(aws_api_gateway_rest_api.lsm-fyp-api))
  }
...
resource "aws_api_gateway_integration_response" "upload_method_options_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.lsm-fyp-api.id
  resource_id = aws_api_gateway_resource.upload_resource.id
  http_method = aws_api_gateway_method.upload_method_options.http_method
  status_code = "200"
