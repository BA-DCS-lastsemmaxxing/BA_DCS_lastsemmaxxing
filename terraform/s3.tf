...
resource "aws_lambda_permission" "allow_s3_trigger" {
  ...
  function_name = aws_lambda_function.zip_lambdas["s3_trigger_lambda"].function_name
...
resource "aws_s3_bucket_notification" "file_upload_trigger" {
  ...
  lambda_function {
    lambda_function_arn = aws_lambda_function.zip_lambdas["s3_trigger_lambda"].arn
