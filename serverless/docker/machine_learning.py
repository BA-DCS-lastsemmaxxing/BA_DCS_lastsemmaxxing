    ...
    def retrain_with_feedback(self, corrected_documents, processor):
        ...
        for doc in corrected_documents:
            ...
            if doc["name"] in df['file_name'].values:
                ...
                df.loc[df['file_name'].str.startswith(doc["file_name"]), 'folder_name'] = doc["user_corrected_category"]
                ...
                s3_client.copy_object(
                    ...
                    Key="Extracted_Sample_Data/" + doc["user_corrected_category"]
                )
                ...
                new_row = pd.DataFrame({'file_name': [base_name + ".txt"], 'folder_name': [doc["user_corrected_category"]]})
