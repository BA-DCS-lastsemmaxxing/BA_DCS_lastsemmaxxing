...
output_directory = os.path.join(os.getcwd(), "output_data")  # Specify the output directory
...
for i in range(0, len(listoffiles)):
    try:
        ...
        output_file = os.path.join(output_directory, listoffiles[i].replace(".pdf", ".txt"))
